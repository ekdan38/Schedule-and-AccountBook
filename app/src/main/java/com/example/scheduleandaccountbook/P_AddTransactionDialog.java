...
public class P_AddTransactionDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView calendarView, int year, int month, int dayOFMonth) {
                P_AddTransactionDialog.this.year = year;
                P_AddTransactionDialog.this.month = month;
                P_AddTransactionDialog.this.dayOFMonth = dayOFMonth;
            }
        });
...
//                            .child(new SimpleDateFormat("yyyy-MM-dd").format(calendar.getTime()));
                ...
                dismiss();
                Intent intent = new Intent(getActivity(), Public_mode_menu.class);//일단은 메뉴로 넘어가게
