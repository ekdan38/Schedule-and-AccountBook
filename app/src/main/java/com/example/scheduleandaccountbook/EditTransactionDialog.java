    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView calendarView, int year, int month, int dayOFMonth) {
                EditTransactionDialog.this.year = year;
                EditTransactionDialog.this.month = month;
                EditTransactionDialog.this.dayOFMonth = dayOFMonth;
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (state.equals("지출")){
                        databasePath = "AccountBook/Personal_User_DB/" + Uid + "/expense";
                    }
                    else{
                        databasePath = "AccountBook/Personal_User_DB/" + Uid + "/income";
                    }
